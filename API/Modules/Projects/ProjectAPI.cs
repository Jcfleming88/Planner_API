...
namespace API
{
    ...
    /// </summary>
    /// <remarks>
    /// All members are implemented as static asynchronous methods and require a <see cref="ProjectDb"/>
    ...
    public class ProjectAPI
    {
        ...
        /// </summary>
        /// <param name="db">The <see cref="ProjectDb"/> database context used to query projects.</param>
        /// <returns>
        /// An <see cref="IResult"/> containing an HTTP 200 (OK) response with the list of <see cref="Project"/> entities.
        /// </returns>
        public static async Task<IResult> GetAllProjects(ProjectDb db)
        {
        ...
        /// <param name="db">The <see cref="ProjectDb"/> database context used to query the project.</param>
        /// <returns>
        ...
        /// </returns>
        public static async Task<IResult> GetProjectById(int id, ProjectDb db)
        {
        ...
        /// <param name="db">The <see cref="ProjectDb"/> database context used to add the new project.</param>
        /// <returns>
        ...
        /// </returns>
        public static async Task<IResult> CreateProject(ProjectDTO projectDTO, ProjectDb db)
        {
        ...
        /// <param name="db">The <see cref="ProjectDb"/> database context used to find and save the project.</param>
        /// <returns>
        /// An <see cref="IResult"/> that is:
        /// - HTTP 204 (NoContent) when the update succeeds;
        /// - HTTP 404 (NotFound) when no project with the specified id exists.
        /// </returns>
        public static async Task<IResult> UpdateProject(int id, Project inputProject, ProjectDb db)
        {
            ...
            project.Users = inputProject.Users;
        ...
        /// <param name="db">The <see cref="ProjectDb"/> database context used to find and remove the project.</param>
        /// <returns>
        /// An <see cref="IResult"/> that is:
        /// - HTTP 204 (NoContent) when the deletion succeeds;
        /// - HTTP 404 (NotFound) when no project with the specified id exists.
        /// </returns>
        public static async Task<IResult> DeleteProject(int id, ProjectDb db)
        {
